        ...
        <SelectContent>
          <SelectItem value="department" data-testid="scope-department">
            <div className="flex items-center gap-2">
              ...
              <span>{departmentName ?? "Current Department"}</span>
            </div>
          </SelectItem>
          <SelectItem value="company" data-testid="scope-company" disabled>
            <div className="flex items-center gap-2">
              <Globe className="w-3.5 h-3.5 text-muted-foreground" />
              <span className="text-muted-foreground">Company Level</span>
              <span className="ml-1 text-[10px] bg-muted text-muted-foreground px-1.5 py-0.5 rounded-full font-medium">Soon</span>
            </div>
          </SelectItem>
        </SelectContent>
      </Select>
