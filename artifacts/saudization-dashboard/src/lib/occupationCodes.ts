...
const RAW: Record<string, OccupationCode> = {
  ...
  "عامل إنشاءات": {
    ...
    officialEn: "Construction labourer (ISCO 9313)",
    confidence: "review",
  },
  "عامل انشاءات": {
    code: "931302",
  ...
  "فني نظم اتصالات": {
    code: "352201",
    officialAr: "فني هندسة اتصالات — مجموعة فنيي هندسة الاتصالات (3522)",
    officialEn: "Telecommunications engineering technician (ISCO 3522)",
    confidence: "review",
  },
  "فني عمليات اتصالات": {
    code: "352201",
    officialAr: "فني هندسة اتصالات — مجموعة فنيي هندسة الاتصالات (3522)",
    officialEn: "Telecommunications operations technician (ISCO 3522)",
    confidence: "review",
  },
  "فني شبكات اتصالات": {
    code: "351301",
  ...
  "كهربائي مباني": {
    code: "741202",
    officialAr: "ميكانيكي كهرباء — مجموعة كهربائيي المباني (7411/7412)",
    officialEn: "Building electrician (ISCO 7411)",
    confidence: "review",
  },
  "مهندس ميكانيكي": {
    code: "214403",
