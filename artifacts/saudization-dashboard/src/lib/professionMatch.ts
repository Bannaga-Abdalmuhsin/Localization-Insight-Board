...
const CATEGORIES: Category[] = [
  ...
  { id: "rigger", family: "network", priority: 3, labelEn: "Rigger / Tower Tech", labelAr: "فني تركيب أبراج",
    enKeywords: ["rigger", "rigging", "tower technician", "tower crew"],
    arKeywords: ["تركيب ابراج", "فني ابراج", "ريجر"] },
  ...
  { id: "admin_specialist", family: "admin", priority: 2, labelEn: "Administration Specialist", labelAr: "أخصائي إداري",
    enKeywords: ["administration specialist", "administrative specialist"],
    arKeywords: ["اخصائي اداري", "أخصائي إداري"] },
  ...
  { id: "gov_relations", family: "admin", priority: 2, labelEn: "Public / Govt Relations (GRO)", labelAr: "علاقات عامة",
    enKeywords: ["government relations", "guest relations", "public relations", "relations officer", "gro", "pro officer"],
    arKeywords: ["علاقات عامة", "علاقات حكومية", "ضابط علاقات", "مندوب علاقات", "اخصائي علاقات", "منسق علاقات"] },
...
const RELATED: Record<string, string[]> = {
  ...
  civil:        ["supervisor", "surveyor", "engineer"],
