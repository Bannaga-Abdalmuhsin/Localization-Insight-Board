...
const CATEGORIES: Category[] = [
  ...
  { id: "admin", family: "admin", priority: 1, labelEn: "Admin / Clerk", labelAr: "إداري / كاتب",
    enKeywords: ["administrative specialist", "office administrator", "office clerk", "administrative assistant", "admin", "administrative", "clerk", "secretary", "coordinator", "receptionist"],
    arKeywords: ["اخصائي اداري", "اداري", "كاتب", "منسق", "سكرتير", "امين", "ادارية"] },
